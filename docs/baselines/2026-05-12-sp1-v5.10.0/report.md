...
- **Seed:** 42
- **Generated at:** 2026-05-12T07:31:22.496837252+00:00
- **Composite BF score:** **59.018** (1.0 = noise floor; lower is better)

## Per-entity DR table

| Entity column | P1 IETD | P1 ACorr | P2 Lifetime | P2 BurstLen avg | P2 JE-line | P3 Fanout avg | P3 Clust | P3 Δlog | P4 mean |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `Source` | 60.14 | 0.90 | 23.16 | 22.61 | 452.80 | 8.57 | 36.65 | 46.09 | 4.51 |
| `TradingPartner` | 0.00 | 8.69 | 0.00 | 0.00 | 452.80 | 0.00 | 119.35 | 345.28 | 0.00 |
