...
- **Seed:** 42
- **Generated at:** 2026-05-12T15:43:08.468392842+00:00
- **Composite BF score:** **36.805** (1.0 = noise floor; lower is better)

## Per-entity DR table

| Entity column | P1 IETD | P1 ACorr | P2 Lifetime | P2 BurstLen avg | P2 JE-line | P3 Fanout avg | P3 Clust | P3 Δlog | P4 mean |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `Source` | 36.75 | 5.84 | 14.63 | 23.81 | 156.48 | 7.18 | 36.65 | 46.09 | 4.13 |
| `TradingPartner` | 0.00 | 8.69 | 0.00 | 0.00 | 156.48 | 0.00 | 119.35 | 345.28 | 0.00 |
