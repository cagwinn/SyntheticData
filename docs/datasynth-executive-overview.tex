...
Accounting Networks           & v5.8.0: \texttt{graphs/je\_network.csv} flat edge-list export (Ivertowski et al., 2024 \cite{ivertowski2024apn}); per-line \texttt{predecessor\_line\_id} traces booking chains across P2P / O2C JEs; line-items-per-JE distribution faithful to Tables II/III of the paper (60.68\% 2-line, 88\% even-count, batch-job tails to 1000+) \\
\bottomrule
\end{tabularx}
