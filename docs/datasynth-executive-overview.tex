...
anomaly-detection thesis). The aim is for downstream Pandas / Polars / Spark
notebooks to need zero ETL.

\subsection{The 38-Column \texttt{journal\_entries.csv}}

The flat CSV writer emits 38 columns covering identifiers, dates, currency,
audit / ETL provenance, and analytics-ready derivations:
