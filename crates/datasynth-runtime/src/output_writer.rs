...
///
/// v5.10: edge construction has been extracted into
/// [`crate::je_network::build_je_network_edges`] so the same logic is
/// reused by the `datasynth-group` aggregate emitter.  The CSV format
/// is unchanged — this writer keeps the v5.8.0 13-column schema.
///
