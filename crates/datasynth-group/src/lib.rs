...
pub use aggregate::{
    ...
    IsLine, NciInputs, NciRollforward, Note, NotesInputs, NotesToConsolidatedFs, PeriodSpec,
    RateBasis, ScheduleLine, StatementOfChangesInEquity, TranslatedLine, TranslatedTb,
