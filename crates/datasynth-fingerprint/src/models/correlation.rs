...
// EmpiricalCdf is defined in datasynth-core to avoid package cycles and
// re-exported here to preserve the public API surface.
pub use datasynth_core::distributions::behavioral_priors::EmpiricalCdf;
