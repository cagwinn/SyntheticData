...
\begin{itemize}
  ...
  \item A \textbf{multi-stage anomaly injection framework}
    (\Cref{sec:anomaly_injection}) with over 130 anomaly subtypes
    across five categories, progressive fraud schemes, and ground-truth
    labels suitable for supervised and semi-supervised learning.
